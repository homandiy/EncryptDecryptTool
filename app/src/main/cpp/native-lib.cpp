...
/**
 * com.huang.homan.encryptdecrypttool.EncryptionTool.Encrypt4C
 * Encryption
 * @param env
 * @param instance
 * @param originByte
...
JNIEXPORT jbyteArray JNICALL Java_com_huang_homan_encryptdecrypttool_EncryptionTool_Encrypt4C_AES_1ECB_1encrypt_1byte
    ...
    jsize alen = env->GetArrayLength(originByte); //key length
...
JNIEXPORT jbyteArray JNICALL Java_com_huang_homan_encryptdecrypttool_EncryptionTool_Encrypt4C_AES_1ECB_1decrypt_1byte
        (JNIEnv *env, jobject instance, jbyteArray originByte, jbyteArray keyByte) {
    jsize len = env->GetArrayLength(originByte); //key length
    unsigned char *originChar = as_unsigned_char_array(env, originByte);
    unsigned char *keyByteChar = as_unsigned_char_array(env, keyByte);
    uint8_t buffer[len];
